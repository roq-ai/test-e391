...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['mortgage-broker'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Credit', path: '/credits', entity: 'credit', service: AccessServiceEnum.PROJECT, icon: FiCreditCard },
    { name: 'Mortgage', path: '/mortgages', entity: 'mortgage', service: AccessServiceEnum.PROJECT, icon: FiHome },
